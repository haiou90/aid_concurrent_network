...
* 配置文件位置:  ~/.gitconfig   <!--cat  ~/.gitconfig-->
...
* 设置忽略文件
  ...
  <!--可以在.gitignore 里设置my.log表示忽略该文件-->
...
* 退回到指定的commit_id节点
  ...
  <!--git reset --hard d5e5e58-->   d5e5e58版本号的前七位
...
<!--用于更改几个不同方案,分别封存多种方案之后保存工作区--> vscode不生效
